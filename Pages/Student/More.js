    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.faqCard}>
        ...
        <Text style={styles.faqText}>
          Students are recorded through sessions you create. Attendance logs are saved in real-time.
        </Text>

        <Text style={styles.faqTitle}>How to join a class?</Text>
        <Text style={styles.faqText}>
          You can join a class by entering the class code generated by the teacher.
        </Text>

        <Text style={styles.faqTitle}>Where are my records saved?</Text>
        <Text style={styles.faqText}>
          All data is stored securely in Firebase Firestore and synced automatically.
        </Text>
      </View>
